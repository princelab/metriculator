...
module Ms
  ...
  class Eksigent
	...
	file.each_line do |line|
	  ...
	  file_test = true if line.chomp == "[FILE]"
	  sample_test = true and file_test = false if line.chomp == "[SAMPLE]"
	  autosampler_test = true and sample_test = false if line.chomp =="[AUTOSAMPLER]"
	  data_test = true and autosampler_test = false if line.chomp == "[DATA]"
