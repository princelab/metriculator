...
describe 'merges hashes down as far as hashes go' do
    ...
    result = @lower_config.deep_merge(@upper_config)
		result.class.should.equal Hash.new.class
	result.sort.should.equal [["archive_root_dir", "ryanmt"], ["comments", "Success!!!"], ["convert", {"overwrite"=>true}], ["group", "JTP"], ["metrics", true], ["quantitation", {"spectral_counts"=>true}], ["search", {"mascot"=>{"run"=>true}, "omssa"=>{"run"=>true}, "tide"=>{"run"=>true}, "xtandem"=>{"run"=>true}, "modifications"=>{"static"=>["MOD:01060"], "variable"=>["MOD:00719", "MOD:01060"]}, "enzyme"=>"Typsin", "spectrum"=>{"parent_mass_type"=>"monoisotopic", "parent_mass_error"=>"-10,+10 ppm", "fragment_mass_type"=>"monoispic", "fragment_mass_error"=>"-0.4,+0.4 daltons"}, "organism"=>nil}], ["taxonomy", "human"], ["useremail", "ryanmt@byu.net"], ["username", "ryanmt"]]
	end
