...
spec = Gem::Specification.new do |s|
  ...
  s.files = Dir['lib/**/*.rb'] + Dir['spec/**/*.rb'] + %w[README.md Gemfile Rakefile] + Dir['lib/**/*.rake'] + Dir['app/models/*.rb'] + Dir['config/**/*.rb'] + Dir['config/database.yml'] + Dir['config/newrelic.yml']
  s.require_path = 'lib'
